...
<body>
        ...
        <div class="content-wrapper flex-grow-1 overflow-auto">
            ...
            <div class="container-fluid py-4">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                    <h1 class="h3">Gestión de Transportes</h1>
                    <div class="d-flex">
                        <button class="btn btn-primary" id="addClientBtn" data-bs-toggle="modal"
                            data-bs-target="#productoModal">
                            <i class="fas fa-user-plus me-2"></i>Nuevo Transporte
                        </button>
                    </div>
                </div>
                ...
                <?php if (isset($_GET['registro']) && $_GET['registro'] === 'eliminado'): ?>
                    <div class="d-flex justify-content-center mt-4">
                        <div class="alert alert-danger alert-dismissible fade show text-center shadow" role="alert"
                            style="max-width: 500px; width: 100%;">
                            !El transporte se eliminó exitosamente!
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Cerrar"></button>
                        </div>
                    </div>
                    <script>
                ...
                <?php if (isset($_GET['registro']) && $_GET['registro'] === 'repetido'): ?>
                    <div class="alert alert-warning alert-dismissible fade show text-center shadow mb-3" role="alert">
                        !El transporte ya está registrada!
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Cerrar"></button>
                    </div>
                    <script>
                        // Eliminar el parámetro 'registro' de la URL
                                ...
                                <tbody id="productosTableBody">
                                    <?php foreach ($arreglo as $producto): ?>
                                        <tr class="text-center">
                                            ...
                                            <td><?php echo $producto->transporte; ?></td>
                                            <td><?php echo $producto->costo_transporte; ?></td>
                                            <td>
    ...
    <div class="modal fade" id="productoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="productoForm" class="needs-validation" novalidate method="post"
                action="../modelo/modelo.php?opcion=28">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Agregar Nuevo Transporte</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="nombre" class="form-label fw-semibold">Nombre del Transporte</label>
                                <input type="text" class="form-control shadow-sm" name="transporte" id="transporte"
                                    required maxlength="35">
                                <div class="invalid-feedback">Solo se permiten letras, espacios y signos básicos. No se
                                    permiten números.</div>
                            </div>
                            <div class="col-md-6">
                                <label for="costo" class="form-label fw-semibold">Costo Transporte</label>
                                <input type="number" class="form-control shadow-sm" name="costo_transporte"
                                    id="costo_transporte" min="0" step="0.01" required>
    ...
    <div class="modal fade" id="productoEdit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="editForm" class="needs-validation" novalidate method="post"
                action="../modelo/modelo.php?opcion=29">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="edit_ntr" class="form-label fw-semibold">Transporte</label>
                                <input type="text" class="form-control shadow-sm" id="edit_nombre" name="transporte"
                                    required>
                                <div class="invalid-feedback">Solo letras. No se permiten números.</div>
                            </div>
                            <div class="col-md-6">
                                <label for="edit_costo" class="form-label fw-semibold">Costo Transporte</label>
                                <input type="number" class="form-control shadow-sm" id="edit_costo"
                                    name="costo_transporte" min="0" step="0.01" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="formEliminar" method="post" action="../modelo/modelo.php?opcion=30">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const costo_transporte = document.getElementById('costo_transporte');

            // Validación en vivo para el campo nombre
            transporte.addEventListener('input', function () {
                const regex = /^[A-Za-zÁÉÍÓÚáéíóúÑñ\s.,()-]+$/;
                if (!regex.test(transporte.value.trim())) {
                    transporte.setCustomValidity("Solo letras. No se permiten números.");
                    transporte.classList.add('is-invalid');
                    transporte.classList.remove('is-valid');
                } else {
                    transporte.setCustomValidity("");
                    transporte.classList.remove('is-invalid');
                    transporte.classList.add('is-valid');
                }
            });
            ...
            form.addEventListener('submit', function (event) {
                ...
                if (!regexNombre.test(transporte.value.trim())) {
                    transporte.setCustomValidity("Solo letras. No se permiten números.");
                    transporte.classList.add('is-invalid');
                    transporte.classList.remove('is-valid');
                    valid = false;
                ...
                // Validar costo
                if (isNaN(costo_transporte.value) || parseFloat(costo_transporte.value) < 0) {
                    costo_transporte.classList.add('is-invalid');
                    valid = false;
                } else {
                    costo_transporte.classList.remove('is-invalid');
                }
    ...
    <script>
        function cargarDatosEditar(producto) {
            ...
            document.getElementById('edit_nombre').value = producto.transporte;
            document.getElementById('edit_costo').value = producto.costo_transporte;
